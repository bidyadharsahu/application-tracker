...
const dict = {
  ...
  doc_delete_job_confirm: { en: "Delete \"{name}\"?",                or: "\"{name}\" ଡିଲିଟ କରିବେ?" },
  ...
  logout:                 { en: "Log Out",                           or: "ବାହାରକୁ ଯାନ୍ତୁ" },
  refresh:                { en: "Refresh",                           or: "ତାଜା କରନ୍ତୁ" },
  ...
  exam_date_hint:         { en: "Type freely — e.g. 15 08 2026 or August 2026",
                            or: "ମୁକ୍ତ ଭାବେ ଲେଖନ୍ତୁ — ଉଦା: ୧୫ ୦୮ ୨୦୨୬ ବା August 2026" },
